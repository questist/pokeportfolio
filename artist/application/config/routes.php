...
$route['dashboard/featured'] = 'dashboard/featured';
$route['dashboard/artsb'] = 'dashboard/artsb';
$route['dashboard/photos'] = 'dashboard/photos';
$route['dashboard/art3d'] = 'dashboard/art3d';
$route['dashboard/submit'] = 'dashboard/submit';
$route['dashboard/art'] = 'dashboard/art';
