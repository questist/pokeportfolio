...
<div class="nav-box">
   <div class="menu" id="home"><span class="menu-hover"></span><a href="<?php echo site_url('home'); ?>" class="<?php if($page == 'home'):echo 'menu-bold';else:echo 'menu-span';endif;?>">About</a></div>
