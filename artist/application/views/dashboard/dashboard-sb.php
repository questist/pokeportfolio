...
<li id="<?php echo "sb_".$i."_".$thumbssb[$i]['id'];?>" class="ui-widget-content ui-corner-tr">
<img src="<?php echo $thumbssb[$i]['thumb_src'];?>" alt="<?php echo $thumbssb[$i]['title']; ?>" width="96" height="72" />
<a href="<?php echo $thumbssb[$i]['orig_src']; ?>" title="View larger image" class="ui-icon ui-icon-zoomin">View larger</a>
...
<li id="<?php echo "sb_".$i."_".$trash[$i]['id'];?>" class="ui-widget-content ui-corner-tr">
