...
<li id="<?php echo "art3d_".$i."_".$thumbs3d[$i]['id'];?>" class="ui-widget-content ui-corner-tr">
<img src="<?php echo $thumbs3d[$i]['thumb_src'];?>" alt="<?php echo $thumbs3d[$i]['title']; ?>" width="96" height="72" />
<a href="<?php echo $thumbs3d[$i]['orig_src']; ?>" title="View larger image" class="ui-icon ui-icon-zoomin">View larger</a>
...
<li id="<?php echo "art3d_".$i."_".$trash[$i]['id'];?>" class="ui-widget-content ui-corner-tr">
